...
namespace HIMS.Services.Common
{
    ...
    {
        Task InsertAsyncSP(Bill objBill, Payment objPayment, List<AddCharge> ObjaddCharge, List<TPayment> ObjTPayment, TDrbill ObjTDrbill , int CurrentUserId, string CurrentUserName);
        ...
        Task RegisteredAppBillInsert(Registration objRegistration, VisitDetail objVisitDetail, Bill objBill, Payment objPayment, List<AddCharge> ObjaddCharge, int CurrentUserId, string CurrentUserName);
        ...
        Task InsertAsyncTDrbill(TDrbill ObjTDrbill, List<TDrbillDet> ObjTDrbillDet, List<TDraddCharge> ObjTDraddCharge, TApprovalHeader ObjTApprovalHeader, int currentUserId, string currentUserName);
