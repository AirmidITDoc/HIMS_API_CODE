...
namespace HIMS.Services.Users
{
    public class UserService : IUserService
    {
        ...
        public virtual async Task<LoginManager> CheckLogin(string UserName, string Password)
        {
            ...
            //          select new TLoginStoreDetail() { LoginId = d.LoginId, StoreId = d.StoreId, StoreName = s.StoreName };
            ...
            //           where d.LoginId == objUser.UserId
            //           select new TLoginUnitDetail() { LoginId = d.LoginId, UnitId = d.UnitId, UnitName = s.HospitalName };
