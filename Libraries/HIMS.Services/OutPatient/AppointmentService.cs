...
namespace HIMS.Services.OutPatient
{
    public class AppointmentService : IAppointmentService
    {
        ...
        public virtual async Task InsertAsyncSP(Registration objRegistration, VisitDetail objVisitDetail, int CurrentUserId, string CurrentUserName)
        {
            ...
            string vRegId = odal.ExecuteNonQuery("m_insert_Registration_1", CommandType.StoredProcedure, "RegId", entity);
            objRegistration.RegId = Convert.ToInt32(vRegId);
            objVisitDetail.RegId = Convert.ToInt32(vRegId);
