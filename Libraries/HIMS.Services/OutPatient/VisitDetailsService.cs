...
namespace HIMS.Services.OutPatient
{
    public class VisitDetailsService : IVisitDetailsService
    {
        ...
        public virtual async Task<IPagedList<AppointmentCancelListDto>> AppointmentCancelAsync(GridRequestModel model)
        {
            return await DatabaseHelper.GetGridDataBySp<AppointmentCancelListDto>(model, "ps_Rtrv_AppointmentCancelList");
        }
        ...
        public virtual async Task UpdateAsyncSP(Registration ObjRegistration ,VisitDetail objVisitDetail, TPatientPolicyInformation ObjTPatientPolicyInformation, int CurrentUserId, string CurrentUserName)
        {
            using var transaction = await _context.Database.BeginTransactionAsync();
