        ...
        public virtual async Task InsertAsyncSP(Bill objBill, Admission objAdmission,Payment objpayment, int CurrentUserId, string CurrentUserName)
        {
            try
            {
                ...
                using var scope = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions { IsolationLevel = System.Transactions.IsolationLevel.ReadCommitted }, TransactionScopeAsyncFlowOption.Enabled);
                {
                    ...
                    //string[] rEntity3 = { "ReceiptNo", "CashCounterId", "IsSelfOrcompany", "CompanyId", "Neftno", "Ch_CashPayAmount", "Ch_ChequePayAmount", "Ch_CardPayAmount", "Ch_AdvanceUsedAmount", "Ch_NEFTPayAmount", "Ch_PayTMAmount", "TranMode" };

                    //var entity3 = objpayment.ToDictionary();
                    //foreach (var rProperty in rEntity)
                    //{
                    //    entity3.Remove(rProperty);
                    //}
                    //string PaymentId = odal.ExecuteNonQuery("m_insert_Payment_1", CommandType.StoredProcedure, "PaymentId", entity3);
