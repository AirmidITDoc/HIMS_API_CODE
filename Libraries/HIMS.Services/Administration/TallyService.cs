...
namespace HIMS.Services.Administration
{
    public class TallyService : ITallyService
    {
        ...
        public virtual async Task<IPagedList<DaywisePharmacySalesOPDListDto>> DaywisePharmacySalesOPDAsync(GridRequestModel model)
        {
        ...
        {
            return await DatabaseHelper.GetGridDataBySp<DaywisePharmacySalesOPDListDto>(model, "ps_Rtrv_DaywisePharmacySalesReturnOPD");
        }
        ...
        public virtual async Task<IPagedList<TallyOPPaymentMediforteDto>> TallyOPPaymentMediforteAsync(GridRequestModel model)
        {
            return await DatabaseHelper.GetGridDataBySp<TallyOPPaymentMediforteDto>(model, "Tally_OP_Payment_Mediforte");
        }
