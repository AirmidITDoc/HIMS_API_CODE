...
namespace HIMS.Services.Administration
{
    public partial interface IPaymentpharmacyService
    {
        ...
        Task<IPagedList<BrowsePharmacyTPaymentReceiptListDto>> GetTPayListAsync(GridRequestModel objGrid);
        ...
        Task GlobalDiscountUpdate(List<TSalesHeader> ObjTSalesHeader, int UserId, string Username);
