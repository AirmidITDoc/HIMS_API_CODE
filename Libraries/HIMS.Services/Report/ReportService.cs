...
namespace HIMS.Services.Report
{
    public class ReportService : IReportService
    {
        ...
        public readonly IBarcodeConfigService _IBarcodeConfigService;
        //public readonly IFileUtility _FileUtility;
        public ReportService(HIMSDbContext HIMSDbContext, IHostingEnvironment hostingEnvironment, IPdfUtility pdfUtility, IBarcodeConfigService barcodeConfigService)
        {
        ...
        public async Task<Tuple<byte[], string>> GetReportSetByProc(ReportRequestModel model, string PdfFontPath = "")
        {
            ...
            switch (model.Mode)
            {
                ...
                case "LabRegistrationListReport":
                    {
                        ...
                        //model.RepoertName = "Lab Registration List";
                        //string[] headerList = { "Sr.No", "UHID", "Visit Date", "Patient Name" };
                        //string[] colList = { "RegNo", "VisitDate", "PatientName" };
                        ...
                        model.RepoertName = "Lab Registration List";
                        string[] headerList = { "Sr.No", "UHID", "Date","Patient Name", "Age", "Gender", "DoctorName", "NetAmount", "ConcessionAmt", "PaidAmt", "BalPayAmt" };
                        string[] colList = { "RegNo", "RegTime", "PatientName", "Age", "GenderName", "DoctorName", "NetPayableAmt", "ConcessionAmt", "PaidAmt", "BalanceAmt", };
                        string htmlFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "SimpleReportFormat.html");
                        string htmlHeaderFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NewHeader.html");
                ...
                #region :: LabPaymentReceipt ::
                case "LabPaymentReceipt":
                    {
                        string[] colList = { "RefundDate", "RegId", "PatientName", "RefundAmount", "TotalAmt" };

                        string htmlFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "LABPaymentReceipt.html");
                        string htmlHeaderFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NewHeader.html");
                        htmlHeaderFilePath = _pdfUtility.GetHeader(htmlHeaderFilePath);
                ...
                case "AppointmentReceipt":
                    {
                        ...
                        string htmlFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "AppointmentReceiptWithHeader.html");
                        string htmlHeaderFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NewHeader.html");
                        htmlHeaderFilePath = _pdfUtility.GetHeader(htmlHeaderFilePath);
                        var html = GetHTMLView("rptAppointmentPrint1", model, htmlFilePath, htmlHeaderFilePath, colList);
                        html = html.Replace("{{NewHeader}}", htmlHeaderFilePath);
                ...
                #region :: LabregisterBillReceipt ::
                case "LabregisterBillReceipt":
                    {
                        string[] colList = { };

                        string htmlFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "LabRegisterbillReceipt.html");
                        string htmlHeaderFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NewHeader.html");
                        htmlHeaderFilePath = _pdfUtility.GetHeader(htmlHeaderFilePath);
                ...
                case "OPPrescriptionA5":
                    {
                        ...
                        html = html.Replace("{{Signature}}", "");
                        html = SetFonts(html, PdfFontPath);
                        tuple = _pdfUtility.GeneratePdfFromHtmlA5(html, model.StorageBaseUrl, "OPPrescriptionNewA5", "OPPrescriptionNewA5" +
                            "" + vDate, Orientation.Portrait);
                ...
                #region :: OPPrescriptionwithoutHeaderA5 ::
                case "OPPrescriptionwithoutHeaderA5":
                    {
                        ...
                        html = html.Replace("{{Signature}}", "");
                        html = SetFonts(html, PdfFontPath);
                        tuple = _pdfUtility.GeneratePdfFromHtmlA5(html, model.StorageBaseUrl, "OPPrescriptionwithoutHeaderA5", "OPPrescriptionwithoutHeaderA5" + vDate, Orientation.Portrait);
                ...
                #endregion
                #region :: NursingPatientHandoverReceipt ::
                case "NursingPatientHandoverReceipt":
                    {

                        string[] colList = { "RegNo", "VisitDate", "PatientName" };
                        string htmlFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NursingPatientHandoverReceipt.html");
                        string htmlHeaderFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NewHeader.html");
                        htmlHeaderFilePath = _pdfUtility.GetHeader(htmlHeaderFilePath);
                ...
                case "IPDInterimBillA5":
                    {
                        ...
                        var html = GetHTMLView("ps_rptIPDInterimBill", model, htmlFilePath, htmlHeaderFilePath, colList);
                        html = html.Replace("{{NewHeader}}", htmlHeaderFilePath);
                        tuple = _pdfUtility.GeneratePdfFromHtmlA5(html, model.StorageBaseUrl, "IPDInterimBill", "IPDInterimBillA5" + vDate, Orientation.Landscape);
                        break;
                ...
                #endregion
                #region :: IpDraftBillGroupWiseA5 ::
                case "IpDraftBillGroupWiseA5":
                    {

                        string[] colList = { };
                        string htmlFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "IPDraftBillGroupWiseA5.html");
                        string htmlHeaderFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NewHeader.html");
                        htmlHeaderFilePath = _pdfUtility.GetHeader(htmlHeaderFilePath);
                        var html = GetHTMLView("m_rptIPD_DraftBillClassWise_Print", model, htmlFilePath, htmlHeaderFilePath, colList);
                        html = html.Replace("{{NewHeader}}", htmlHeaderFilePath);
                        tuple = _pdfUtility.GeneratePdfFromHtmlA5(html, model.StorageBaseUrl, "IpDraftBill", "IpDraftBillGroupWiseA5" + vDate, Orientation.Portrait);
                        break;
                ...
                #region :: IpDraftBillClassWiseA5 ::
                case "IpDraftBillClassWiseA5":
                    {

                        string[] colList = { };
                        string htmlFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "IpDraftBillClassWiseA5.html");
                        string htmlHeaderFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NewHeader.html");
                        htmlHeaderFilePath = _pdfUtility.GetHeader(htmlHeaderFilePath);
                        var html = GetHTMLView("m_rptIPD_DraftBillSummary_Print", model, htmlFilePath, htmlHeaderFilePath, colList);
                        html = html.Replace("{{NewHeader}}", htmlHeaderFilePath);

                        tuple = _pdfUtility.GeneratePdfFromHtmlA5(html, model.StorageBaseUrl, "IpDraftBill", "IpDraftBillClassWiseA5" + vDate, Orientation.Portrait);
                        break;
                ...
                #region :: IpDischargeSummaryTemplatewithPatientHeader ::
                ...
                #region :: IpDischargeSummaryTemplatepatientWithoutHeader ::
                case "IpDischargeSummaryTemplatepatientWithoutHeader":
                    {

                        string[] colList = { };

                        string htmlFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "IPDiscsumTempPatientheaderwithoutHeader.html");
                        string htmlHeaderFilePath1 = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NewHeader.html");
                        htmlHeaderFilePath1 = _pdfUtility.GetHeader(htmlHeaderFilePath1);
                ...
                case "PathologyReportWithHeader":
                    {
                        ...
                        string htmlHeaderFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NewHeader.html");
                        htmlHeaderFilePath = _pdfUtility.GetHeader(htmlHeaderFilePath);
                        var html = GetHTMLView("ps_rptPathologyReportPrintMultiple", model, htmlFilePath, htmlHeaderFilePath, colList, headerList);
                        html = html.Replace("{{NewHeader}}", htmlHeaderFilePath);
                ...
                case "PathologyReportWithImgHeader":
                    {
                        ...
                        string[] headerList = Array.Empty<string>();
                        string[] colList = Array.Empty<string>();
                        string htmlFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "PathologyResultTestImg.html");
                        ...
                        //var signature = _pdfUtility.GetBase64FromFolder("Doctors\\Signature", dt.Rows[0]["Signature"].ConvertToString());
                ...
                case "PathologyReportTemplateWithHeader":
                    {
                        ...
                        string htmlHeaderFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NewHeader.html");
                        htmlHeaderFilePath = _pdfUtility.GetHeader(htmlHeaderFilePath);
                        var html = GetHTMLView("ps_rptPathologyReportPrintMultiple", model, htmlFilePath, htmlHeaderFilePath, colList);
                        html = html.Replace("{{NewHeader}}", htmlHeaderFilePath);
                ...
                #region :: PathologyReporKenyatWithHeader ::
                case "PathologyReporKenyatWithHeader":
                    {
                        ...
                        string[] headerList = Array.Empty<string>();
                        string[] colList = Array.Empty<string>();
                        string htmlFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "PathologyResultTestReport.html");
                        string htmlHeaderFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NewHeader.html");
                        htmlHeaderFilePath = _pdfUtility.GetHeader(htmlHeaderFilePath);
                ...
                case "OTReservation":
                    {
                        ...
                        string htmlFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "OTReservation.html");
                        string htmlHeaderFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NewHeader.html");
                        htmlHeaderFilePath = _pdfUtility.GetHeader(htmlHeaderFilePath);
                ...
                case "NursingVitalsReport":
                    {
                        ...
                        string htmlHeaderFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NewHeader.html");
                        htmlHeaderFilePath = _pdfUtility.GetHeader(htmlHeaderFilePath);
                        var html = GetHTMLView("m_rpt_ClinicalData_All", model, htmlFilePath, htmlHeaderFilePath, colList);
                        html = html.Replace("{{NewHeader}}", htmlHeaderFilePath);
                ...
                #region :: OTAnaesthesiaRecord ::
                case "OTAnaesthesiaRecord":
                    {
                        string[] colList = { };

                        string htmlFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "OTAnaesthesiaRecord.html");
                        string htmlHeaderFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NewHeader.html");
                        htmlHeaderFilePath = _pdfUtility.GetHeader(htmlHeaderFilePath);
                        var html = GetHTMLView("ps_Rtrv_OTAnesthesiaRecord", model, htmlFilePath, htmlHeaderFilePath, colList);
                        html = html.Replace("{{NewHeader}}", htmlHeaderFilePath);
                ...
                #region :: OTCheckInOutPatientWise ::
                ...
                #region :: OTPreOperationReport ::
                case "OTPreOperationReport":
                    {
                        string[] colList = { };

                        string htmlFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "OTPreOperationReport.html");
                        string htmlHeaderFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NewHeader.html");
                        htmlHeaderFilePath = _pdfUtility.GetHeader(htmlHeaderFilePath);
                        var html = GetHTMLView("ps_rtrv_OT_PreOperationReport", model, htmlFilePath, htmlHeaderFilePath, colList);
                        html = html.Replace("{{NewHeader}}", htmlHeaderFilePath);
                ...
                #region :: OTRequestReport ::
                case "OTRequestReport":
                    {
                        string[] colList = { };

                        string htmlFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "OTRequestReport.html");
                        string htmlHeaderFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NewHeader.html");
                        htmlHeaderFilePath = _pdfUtility.GetHeader(htmlHeaderFilePath);
                        var html = GetHTMLView("ps_Rtrv_OTRequest", model, htmlFilePath, htmlHeaderFilePath, colList);
                        html = html.Replace("{{NewHeader}}", htmlHeaderFilePath);
                ...
                #region ::OTOperativeNotesReport ::
                case "OTOperativeNotesReport":
                    {
                        string[] colList = { };

                        string htmlFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "OTOperativeNotesReport.html");
                        string htmlHeaderFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NewHeader.html");
                        htmlHeaderFilePath = _pdfUtility.GetHeader(htmlHeaderFilePath);
                        var html = GetHTMLView("ps_rpt_OT_OperativeNotes", model, htmlFilePath, htmlHeaderFilePath, colList);
                        html = html.Replace("{{NewHeader}}", htmlHeaderFilePath);
                ...
                //#region :: OTOprativereport ::
                //case "OTOprativereport":
                //    {
                //        string[] colList = { };

                //        string htmlFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "OTOprativeReport.html");
                //        string htmlHeaderFilePath = Path.Combine(_hostingEnvironment.WebRootPath, "PdfTemplates", "NewHeader.html");
                //        htmlHeaderFilePath = _pdfUtility.GetHeader(htmlHeaderFilePath);
                //        var html = GetHTMLView("rptRtrv_OTReservation", model, htmlFilePath, htmlHeaderFilePath, colList);
                //        html = html.Replace("{{NewHeader}}", htmlHeaderFilePath);

                //        tuple = _pdfUtility.GeneratePdfFromHtml(html, model.StorageBaseUrl, "OTOprativereport", "OTOprativereport" + vDate, Orientation.Portrait);
                //        break;
                //    }
                //    #endregion
                ...
                case "IpDischargeSummaryReport":
                    {
                        ...
                        {
                            i++;
                            items.Append("<tr style=\"text-align: center; padding: 6px;font-family: Calibri,'Helvetica Neue', 'Helvetica',, sans-serif;font-size: 18px;\"><td style=\"border: 1px solid #000;text-align: center; padding: 4px;\">").Append(i).Append("</td>");
                            items.Append("<td style=\"border-left: 1px solid #000;border-top: 1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000; text-align: left;font-size: 18px; padding: 4px;\">").Append(dr["ItemName"].ConvertToString())/*.Append("<br>").Append(dr["ItemGenericName"].ConvertToString())*/.Append("</td>");
                            items.Append("<td style=\"border-left: 1px solid #000;border-top: 1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000; text-align: center;font-size: 18px; padding: 4px;\">").Append(dr["DoseName"].ConvertToString()).Append("</td>");
                            items.Append("<td style=\"border-left: 1px solid #000;border-top: 1px solid #d4c3c3;border-right: 1px solid #000;border-bottom: 1px solid #000;text-align: center;font-size: 18px; padding: 4px;\">").Append(dr["DoseNameInEnglish"].ConvertToString()).Append("</td>");
                            ...
                            items.Append("<td style=\"border-left: 1px solid #000;border-top: 1px solid #000;border-right: 1px solid #000;border-bottom: 1px solid #000;  text-align: center;font-size: 18px; padding: 4px;\">").Append(dr["Days"].ConvertToString()).Append("</td></tr>");
                ...
                case "IpDischargeSummaryReportWithoutHeader":
                    {
                        ...
                        {
                            i++;
                            items.Append("<tr style=\" text-align: center; padding: 6px;font-family: Calibri,'Helvetica Neue', 'Helvetica',, sans-serif;font-size: 18px;\"><td style=\"border-left: 1px solid #d4c3c3;text-align: center; padding: 4px;\">").Append(i).Append("</td>");
                            items.Append("<td style=\"border-left: 1px solid #d4c3c3;border-top: 1px solid #d4c3c3;border-right: 1px solid #d4c3c3; text-align: left;font-size: 18px; padding: 4px;\">").Append(dr["ItemName"].ConvertToString())/*.Append("<br>").Append(dr["ItemGenericName"].ConvertToString())*/.Append("</td>");
                            items.Append("<td style=\"border-left: 1px solid #d4c3c3;border-top: 1px solid #d4c3c3;border-right: 1px solid #d4c3c3; text-align: center;font-size: 18px; padding: 4px;\">").Append(dr["DoseName"].ConvertToString()).Append("</td>");
                            items.Append("<td style=\"border-left: 1px solid #d4c3c3;border-top: 1px solid #d4c3c3;border-right: 1px solid #d4c3c3;text-align: center;font-size: 18px; padding: 4px;\">").Append(dr["DoseNameInEnglish"].ConvertToString()).Append("</td>");
                            //items.Append("<td style=\"border-right: 1px solid #d4c3c3;border-top: 1px solid #d4c3c3;border-bottom: 1px solid #d4c3c3; text-align: center; padding: 6px;\">").Append("(").Append(dr["DoseNameInMarathi"].ConvertToString()).Append(")").Append("</td>");
                            items.Append("<td style=\"border-left: 1px solid #d4c3c3;border-top: 1px solid #d4c3c3;border-right: 1px solid #d4c3c3;  text-align: center;font-size: 18px; padding: 4px;\">").Append(dr["Days"].ConvertToString()).Append("</td></tr>");
                ...
                case "IpDischargeSummaryTemplatepatientWithoutHeader":
                    {
                        ...
                        //logoFileName
                        //var logo = this._context.FileMasters.FirstOrDefault(x => x.RefType == 7 && x.RefId == 1 && x.IsDelete == false);

                        //var HospitalLogo = _pdfUtility.GetBase64FromFolder("Hospital\\Logo", logo.DocSavedName);
                       
                        //var logo =   _context.FileMasters.FirstOrDefault(x => x.RefType == 7 && x.RefId == 1 && x.IsDelete == false);


                        //var HospitalLogo = string.IsNullOrWhiteSpace(this._pdfUtility.GetBase64FromFolder("Hospital\\Logo", logo.DocSavedName));

                      

                        //html = html.Replace("{{Header}}", HospitalLogo);
                ...
                case "OpBillReceiptT":
                    {
                        ...
                        foreach (DataRow dr in dt.Rows)
                        {
                            ...
                            //items.Append("<td style=\"border: 1px solid #d4c3c3; text-align: center; padding: 6px;\">").Append(dr["Price"].ConvertToDouble().ToString("F2")).Append("</td>");
                            //items.Append("<td style=\"border: 1px solid #d4c3c3; text-align: center; padding: 6px;\">").Append(dr["Qty"].ConvertToString()).Append("</td>");
                            items.Append("<td style=\"text-align: right; padding: 2px; font-size:14px;\">").Append(dr["ChargesTotalAmount"].ConvertToDouble().ToString("F2")).Append("</td>");
                            //items.Append("<td style=\"border: 1px solid #d4c3c3; text-align: center; padding: 6px;\">").Append(dr["ConcessionAmount"].ConvertToDouble().ToString("F2")).Append("</td>");
                            //items.Append("<td style=\"border: 1px solid #d4c3c3; text-align: center; padding: 6px;\">").Append(dr["NetAmount"].ConvertToDouble().ToString("F2")).Append("</td></tr>");
                ...
                case "LabregisterBillReceipt":
                    {
                        ...
                        foreach (DataRow dr in dt.Rows)
                        {
                            i++;
                            items.Append("<tr style=\"font-family: 'Helvetica Neue', 'Helvetica',, Arial, sans-serif;font-size:15;\"><td style=\"border: 1px solid #d4c3c3; text-align: center; padding: 6px;\">").Append(i).Append("</td>");
                            items.Append("<td style=\"border: 1px solid #000; text-align: left; padding: 6px;\">").Append(dr["ServiceName"].ConvertToString()).Append("</td>");
                            //items.Append("<td style=\"border: 1px solid #d4c3c3; text-align: center; padding: 6px;\">").Append(dr["ChargesDoctorName"].ConvertToString()).Append("</td>");
                            items.Append("<td style=\"border: 1px solid #000; text-align: center; padding: 6px;\">").Append(dr["Price"].ConvertToDouble().ToString("F2")).Append("</td>");
                            items.Append("<td style=\"border: 1px solid #000; text-align: center; padding: 6px;\">").Append(dr["Qty"].ConvertToString()).Append("</td>");
                            //items.Append("<td style=\"border: 1px solid #d4c3c3; text-align: center; padding: 6px;\">").Append(dr["ChargesTotalAmount"].ConvertToDouble().ToString("F2")).Append("</td>");
                            //items.Append("<td style=\"border: 1px solid #d4c3c3; text-align: center; padding: 6px;\">").Append(dr["ConcessionAmount"].ConvertToDouble().ToString("F2")).Append("</td>");
                            items.Append("<td style=\"border: 1px solid #000; text-align: center; padding: 6px;\">").Append(dr["Price"].ConvertToDouble().ToString("F2")).Append("</td></tr>");
                ...
                case "DoctorPatientHandoverReceipt":
                    {
                        ...
                        foreach (DataRow dr in dt.Rows)
                        {
                            ...
                            items.Append("<tr style\"font-family: 'Helvetica Neue', 'Helvetica',, Arial, sans-serif;\"><td style=\" border: 1px solid #d4c3c3; text-align: center; padding: 6px;\">").Append(dr["TTime"].ConvertToDateString("dd/MM/yyyy | hh:mm tt")).Append("</td>");
                ...
                case "IPDInterimBill":
                    {
                        ...
                        foreach (DataRow dr in dt.Rows)
                        {
                            ...
                            if (i == 1)
                            {
                                ...
                                items.Append("<tr style=\"font-size:15px;border: 1px;font-family: 'Helvetica Neue', 'Helvetica',, Arial, sans-serif;\"><td colspan=\"13\" style=\"border:1px solid #eee;border-collapse: collapse;padding:3px;height:10px;text-align:left;vertical-align:middle;font-weight:bold;\">").Append(Label).Append("</td></tr>");
                            }
                            if (previousLabel != "" && previousLabel != dr["GroupName"].ConvertToString())
                            {
                                j = 1;
                                items.Append("<tr style='font-size:15px;border:1px solid black;font-family: 'Helvetica Neue', 'Helvetica',, Arial, sans-serif;'><td colspan='5' style=\"border:1px solid #eee;border-collapse: collapse;padding:3px;height:10px;text-align:right;vertical-align:middle;margin-right:15px;font-weight:bold;\">Group Wise Total</td><td style=\"border-right:1px solid #eee;padding:3px;height:10px;text-align:right;vertical-align:right;font-weight:bold;\">")

                               .Append(T_TotalAmount.To2DecimalPlace()).Append("</td></tr>");
                                T_TotalAmount = 0;

                                items.Append("<tr style=\"font-size:15px;font-family: 'Helvetica Neue', 'Helvetica',, Arial, sans-serif;border-bottom: 1px;\"><td colspan=\"13\" style=\"border:1px solid #eee;border-collapse: collapse;padding:3px;height:10px;text-align:left;vertical-align:middle;font-weight:bold;\">").Append(dr["GroupName"].ConvertToString()).Append("</td></tr>");
                            ...
                            items.Append("<td style=\"border: 1px solid #eee; text-align: center; padding: 2px;font-size:14px;font-family:'Helvetica Neue', 'Helvetica',, Arial, sans-serif;\">").Append(dr["Price"].ConvertToDouble().ToString("F2")).Append("</td>");
                            ...
                            items.Append("<td style=\"border: 1px solid #eee; text-align: right; padding: 2px;font-size:14px;font-family:'Helvetica Neue', 'Helvetica',, Arial, sans-serif;\">").Append(dr["ChargesTotalAmt"].ConvertToDouble().ToString("F2")).Append("</td></tr>");

                            if (dt.Rows.Count > 0 && dt.Rows.Count == i)
                            {

                                items.Append("<tr style='border:1px solid black;font-weight:bold;font-family:'Helvetica Neue', 'Helvetica',, Arial, sans-serif;font-size:25px;'><td colspan='5' style=\"border:1px solid #eee;border-bottom:1px solid #eee;border-collapse: collapse;padding:3px;height:10px;text-align:right;vertical-align:middle;margin-right:15px;font-weight:bold;font-size:15px;\">Group Wise Amount</td><td style=\"border-right:1px solid #eee;border-bottom:1px solid #eee;padding:3px;height:10px;text-align:right;vertical-align:middle;font-weight:bold;font-size:15px;\">")
                ...
                case "IpDraftBillGroupWise":
                    {
                        ...
                        foreach (DataRow dr in dt.Rows)
                        {
                            ...
                            if (i == 1)
                            {
                                String Label;
                                Label = dr["GroupName"].ConvertToString();
                                items.Append("<tr style=\"font-size:15px;font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif;border: 1px;\"><td colspan=\"13\" style=\"border:1px solid #eee;border-collapse: collapse;padding:3px;height:10px;text-align:left;vertical-align:middle;font-weight:bold;\">").Append(Label).Append("</td></tr>");
                            }
                            if (previousLabel != "" && previousLabel != dr["GroupName"].ConvertToString())
                            {
                                j = 1;
                                items.Append("<tr style='font-size:15px;border:1px solid #eee;font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif;'><td colspan='5' style=\"border:1px solid #eee;border-collapse: collapse;padding:3px;height:10px;text-align:right;vertical-align:middle;margin-right:20px;font-weight:bold;\">Group Wise Total</td><td style=\"border-right:1px solid #eee;padding:3px;height:10px;text-align:right;vertical-align:middle\">")

                               .Append(T_TotalAmount.To2DecimalPlace()).Append("</td></tr>");
                                T_TotalAmount = 0;

                                items.Append("<tr style=\"font-size:15px;border-bottom: 1px;font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif;\"><td colspan=\"13\" style=\"border:1px solid #eee;border-collapse: collapse;padding:3px;height:10px;text-align:left;vertical-align:middle;font-weight:bold;\">").Append(dr["GroupName"].ConvertToString()).Append("</td></tr>");
                        ...
                        foreach (DataRow dr in dt.Rows)
                        {
                            ...
                            if (previousLabel != "" && previousLabel != dr["GroupName"].ConvertToString())
                            {
                               ...
                               .Append(T_TotalAmount.To2DecimalPlace()).Append("</td></tr>");
                                ...
                                items.Append("<tr style=\"font-size:15px;border-bottom: 1px solid #eee;font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif;\"><td colspan=\"13\" style=\"border:1px solid #eee;border-collapse: collapse;padding:3px;height:10px;text-align:left;vertical-align:middle;font-weight:bold;\">").Append(dr["GroupName"].ConvertToString()).Append("</td></tr>");
                ...
                case "IpDraftBillClassWise":
                    {
                        ...
                        foreach (DataRow dr in dt.Rows)
                        {
                            ...
                            items.Append("<td style=\"text-align: right; padding: 2px;font-size:16px;font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif;\">").Append(dr["TotalAmt"].ConvertToDouble()).Append("</td></tr>");
                ...
                case "IPFinalBillClassWise":
                    {
                        ...
                        foreach (DataRow dr in dt.Rows)
                        {
                            ...
                            items.Append("<tr style=\"font-family: 'Helvetica Neue','Helvetica',, Arial, sans-serif;font-size:14px;\"><td style=\"text-align: Center; padding: 2px;\">").Append(j).Append("</td>");
                            ...
                            if (i == length + 1)
                            {
                                ...
                                items.Append("<tr style='font-size:15px;border:1px solid ;font-family: 'Helvetica Neue', 'Helvetica',, Arial, sans-serif;'><td colspan='6' style=\"border:1px solid #000;border-collapse: collapse;padding:3px;height:10px;text-align:right;vertical-align:middle;margin-right:20px;font-weight:bold;\">Class Wise Total</td><td style=\"border-right:1px solid #000;padding:3px;height:10px;text-align:right;vertical-align:middle;font-weight:bold;\">")
                                .Append(T_TotalAmount.To2DecimalPlace()).Append("</td></tr>");
                ...
                case "IPFinalBillClassServiceWise":
                    {
                        ...
                        foreach (DataRow dr in dt.Rows)
                        {
                            ...
                            if (i == 1)
                            {
                                ...
                                items.Append("<tr style=\"font-size:15px;font-family: 'Helvetica Neue', 'Helvetica',, Arial, sans-serif;border: 1px;font-weight:bold;\"><td colspan=\"13\" style=\"border:1px solid #eee;border-collapse: collapse;padding:3px;height:10px;text-align:left;vertical-align:middle\">").Append(Label2).Append("</td></tr>");
                            ...
                            if (ClassLable != "" && ClassLable != dr["ClassName"].ConvertToString())
                            {
                                ...
                                items.Append("<tr style=\"font-size:15px;border-bottom: 1px;font-weight:bold;\"><td colspan=\"13\" style=\"border:1px solid #eee;border-collapse: collapse;padding:3px;height:10px;text-align:left;vertical-align:middle;font-family: 'Helvetica Neue', 'Helvetica',, Arial, sans-serif;\">").Append(dr["ClassName"].ConvertToString()).Append("</td></tr>");

                                if (dt.Rows.Count == i)
                                {
                                    items.Append("<tr style=\"font-size:15px;border-bottom: 1px;\"><td colspan=\"13\" style=\"border:1px solid #eee;border-collapse: collapse;padding:3px;height:10px;text-align:left;vertical-align:middle;font-family: 'Helvetica Neue', 'Helvetica',, Arial, sans-serif;\">").Append(dr["GroupName"].ConvertToString()).Append("</td></tr>");
                            ...
                            if (dt.Rows.Count > 0 && dt.Rows.Count == i && i != length + 1)
                            {
                                items.Append("<tr style='font-size:15px;border:1px solid black;font-family: 'Helvetica Neue', 'Helvetica',, Arial, sans-serif;'><td colspan='5' style=\"border:1px solid #eee;border-collapse: collapse;padding:3px;height:10px;text-align:right;vertical-align:middle;margin-right:20px;font-weight:bold;\">Class Wise Total</td><td style=\"border-right:1px solid #eee;padding:3px;height:10px;text-align:right;vertical-align:middle;font-weight:bold;\">")
                                 .Append(T_TotalAmount.To2DecimalPlace()).Append("</td></tr>");
                            ...
                            if (i == length + 1)
                            {
                                ...
                                T_TotalAmount = T_TotalAmount - Tot;
                                items.Append("<tr style='font-size:18px;border:1px solid black;font-family: 'Helvetica Neue', 'Helvetica',, Arial, sans-serif;'><td colspan='5' style=\"border:1px solid #eee;border-collapse: collapse;padding:3px;height:10px;text-align:right;vertical-align:middle;margin-right:20px;font-weight:bold;\">Class Wise Total</td><td style=\"border-right:1px solid #eee;padding:3px;height:10px;text-align:right;vertical-align:middle;font-weight:bold;\">")
                                .Append(T_TotalAmount.To2DecimalPlace()).Append("</td></tr>");
                ...
                case "LabRegistrationListReport":
                    {
                        ...
                        // Group data by AdmittedDoctorName
                        var groupedData = dt.AsEnumerable()
                                            .GroupBy(row => row["DoctorName"].ConvertToString())
                                            .ToList();
                ...
                case "PathologyReporKenyatWithHeader":
                    {
                        ...
                        foreach (DataRow dr in dt.Rows)
                        {
                            ...
                            if (i == 1)
                            {
                                items.Append("<tr style=\"font-size:12px;font-family:Calibri,'Helvetica Neue',Helvetica,Arial,sans-serif;font-weight:bold;\">")
                                     .Append("<td colspan=\"4\" style=\"padding:3px;text-align:center;\">")
                            ...
                            if (previousLabel != "" && previousLabel != dr["PrintTestName"].ConvertToString())
                            {
                                ...
                                if (Suggestion != "")
                                {
                                    items.Append("<tr><td colspan=\"4\" style=\"font-size:12px;font-weight:bold;padding:3px;\">Interpretation Remark :</td></tr>");
                                    items.Append("<tr><td colspan=\"4\" style=\"font-size:12px;padding:3px;\">")
                                         .Append(Suggestion)
                                         .Append("</td></tr>");
                                }
                            ...
                            // ===== Result Rows =====
                            if (dr["ResultValue"].ConvertToString().Trim() != "")
                            {
                                k++;
                                ...
                                if (k == 1 && dr["SubTestName"].ConvertToString() != "")
                                {
                                    ...
                                    items.Append("<tr style=\"font-size:12px;font-weight:bold;\">")
                                         .Append("<td colspan=\"4\" style=\"padding:3px;text-align:left;\">")
                                         .Append(previoussubLabel)
                                         .Append("</td></tr>");
                                }
                                ...
                                // ===== Parameter Name =====
                                items.Append("<tr style=\"font-family:Calibri,'Helvetica Neue',Helvetica,Arial,sans-serif;\">");

                                if (dr["IsBoldFlag"].ConvertToString() == "B")
                                    items.Append("<td style=\"font-size:12px;font-weight:bold;padding:3px;text-align:left;\">");
                                else
                                    items.Append("<td style=\"font-size:12px;padding:3px;text-align:left;\">");

                                items.Append(dr["PrintParameterName"].ConvertToString()).Append("</td>");

                                // ===== Observed Value =====
                                if (dr["ParaBoldFlag"].ConvertToString() == "B")
                                    items.Append("<td style=\"font-size:12px;font-weight:bold;padding:3px;text-align:center;\">");
                                else
                                    items.Append("<td style=\"font-size:12px;padding:3px;text-align:center;\">");

                                items.Append(dr["ResultValue"].ConvertToString()).Append("</td>");

                                // ===== Reference Range =====
                                if (dr["NormalRange"].ConvertToString() != " -   ")
                                {
                                    items.Append("<td style=\"font-size:12px;padding:3px;text-align:left;\">")
                                         .Append(dr["NormalRange"].ConvertToString())
                                         .Append("</td>");
                                }
                                else
                                {
                                    items.Append("<td style=\"font-size:12px;padding:3px;text-align:left;\"></td>");
                                }
                ...
                case "OTReservation":
                    {
                        ...
                        // 26 → 30
                        // -------------------------------
                        html = html.Replace("{{SurgeryDate}}",
                            dt.GetColValue("SurgeryDate").ConvertToDateString("dd-MM-yyyy"));
                        html = html.Replace("{{Diagnosis}}", dt.GetColValue("Diagnosis"));
                        html = html.Replace("{{Comments}}", dt.GetColValue("Comments"));
                        html = html.Replace("{{ReservationType}}", dt.GetColValue("ReservationType"));
                ...
                case "OTAnaesthesiaRecord":
                    {
                        ...
                        // ===== Anaesthesia Details =====
                        html = html.Replace("{{AnesthesiaNo}}", dt.GetColValue("AnesthesiaNo"));
                        html = html.Replace("{{AnaesthesiaType}}", dt.GetColValue("AnaesthesiaType"));
                        html = html.Replace("{{AnesthesiaNotes}}", dt.GetColValue("AnesthesiaNotes"));

                        html = html.Replace("{{AnesthesiaDate}}",
                            dt.GetColValue("AnesthesiaDate").ConvertToDateString("dd-MM-yyyy"));

                        html = html.Replace("{{AnesthesiaStartDate}}",
                            dt.GetColValue("AnesthesiaStartDate").ConvertToDateString("dd-MM-yyyy"));
                        html = html.Replace("{{AnesthesiaStartTime}}",
                            dt.GetColValue("AnesthesiaStartTime").ConvertToDateString("hh:mm tt"));

                        html = html.Replace("{{AnesthesiaEndDate}}",
                            dt.GetColValue("AnesthesiaEndDate").ConvertToDateString("dd-MM-yyyy"));
                        html = html.Replace("{{AnesthesiaEndTime}}",
                            dt.GetColValue("AnesthesiaEndTime").ConvertToDateString("hh:mm tt"));

                        // ===== Recovery Details =====
                        html = html.Replace("{{RecoveryStartDate}}",
                            dt.GetColValue("RecoveryStartDate").ConvertToDateString("dd-MM-yyyy"));
                        html = html.Replace("{{RecoveryStartTime}}",
                            dt.GetColValue("RecoveryStartTime").ConvertToDateString("hh:mm tt"));

                        html = html.Replace("{{RecoveryEndDate}}",
                            dt.GetColValue("RecoveryEndDate").ConvertToDateString("dd-MM-yyyy"));
                        html = html.Replace("{{RecoveryEndTime}}",
                            dt.GetColValue("RecoveryEndTime").ConvertToDateString("hh:mm tt"));
                ...
                case "OTInOperationReport":
                    {
                        ...
                        // OT Timing Details
                        // -------------------------------
                        html = html.Replace("{{TheaterInDate}}",
                            dt.GetColValue("TheaterInDate").ConvertToDateString("dd-MM-yyyy"));
                        html = html.Replace("{{TheaterInTime}}",
                            dt.GetColValue("TheaterInTime").ConvertToDateString("hh:mm tt"));
                        html = html.Replace("{{TheaterOutDate}}",
                            dt.GetColValue("TheaterOutData").ConvertToDateString("dd-MM-yyyy"));
                        html = html.Replace("{{TheaterOutTime}}",
                            dt.GetColValue("TheaterOutTime").ConvertToDateString("hh:mm tt"));
                        ...
                        html = html.Replace("{{PostOperativeDiagnosisName}}",
                            dt.GetColValue("InOperationPostOperDiagnosisName"));
                        html = html.Replace("{{PostOperativeDiagnosisType}}",
                            dt.GetColValue("InOperationPostOperDiagnosisType"));
                        ...
                        html = html.Replace("{{ConditionOfPatientNotes}}",
                            dt.GetColValue("ConditionOfPatientNotes"));
                ...
                case "OTPreOperationReport":
                    {
                        ...
                        html = html.Replace("{{OPDIPDNo}}", dt.GetColValue("IPDNo"));
                        html = html.Replace("{{PatientName}}",
                            $"{dt.GetColValue("PrefixName")} {dt.GetColValue("FirstName")} {dt.GetColValue("LastName")}");
                        html = html.Replace("{{Gender}}", dt.GetColValue("GenderName"));
                        html = html.Replace("{{AgeYear}}", dt.GetColValue("AgeYear"));
                        html = html.Replace("{{AgeMonth}}", dt.GetColValue("AgeMonth"));
                        html = html.Replace("{{AgeDay}}", dt.GetColValue("AgeDay"));
                        ...
                        html = html.Replace("{{DOATime}}",
                            dt.GetColValue("AdmissionTime").ConvertToDateString("hh:mm tt"));
                        html = html.Replace("{{PatientType}}", dt.GetColValue("PatientType"));
                        html = html.Replace("{{PatientTypeID}}", dt.GetColValue("PatientTypeID"));
                        ...
                        html = html.Replace("{{SurgeryName}}", dt.GetColValue("SurgeryName"));
                        html = html.Replace("{{SurgeryCategoryName}}", dt.GetColValue("SurgeryCategoryName"));
                        html = html.Replace("{{SiteDescriptionName}}", dt.GetColValue("SurgeryPart"));
                        html = html.Replace("{{IsPrimary}}", dt.GetColValue("IsPrimary"));

                        // Surgeon Details (Expr4, Expr5, Expr6 = Mr. Nitin Patil)
                        html = html.Replace("{{SurgeonName}}",
                            $"{dt.GetColValue("Expr4")} {dt.GetColValue("Expr5")} {dt.GetColValue("Expr6")}");
                        html = html.Replace("{{SurgeonPrefix}}", dt.GetColValue("Expr4"));
                        html = html.Replace("{{SurgeonFirstName}}", dt.GetColValue("Expr5"));
                        html = html.Replace("{{SurgeonLastName}}", dt.GetColValue("Expr6"));

                        // Primary Doctor Details (PrefixName, FirstName, LastName = Dr. mukesh Gandhi)
                        html = html.Replace("{{PrimaryDoctorName}}",
                            $"{dt.GetColValue("PrefixName")} {dt.GetColValue("FirstName")} {dt.GetColValue("LastName")}");
                        html = html.Replace("{{DoctorId}}", dt.GetColValue("DoctorId"));

                        // Anesthetist Details (Expr1, Expr2, Expr3 = Dr. Shrishal Teli)
                        html = html.Replace("{{AnesthetistName}}",
                            $"{dt.GetColValue("Expr1")} {dt.GetColValue("Expr2")} {dt.GetColValue("Expr3")}");
                        html = html.Replace("{{AnesthetistPrefix}}", dt.GetColValue("Expr1"));
                        html = html.Replace("{{AnesthetistFirstName}}", dt.GetColValue("Expr2"));
                        html = html.Replace("{{AnesthetistLastName}}", dt.GetColValue("Expr3"));

                        // Doctor Type Details
                        html = html.Replace("{{DoctorType}}", dt.GetColValue("DoctorType"));
                        html = html.Replace("{{DoctorTypeId}}", dt.GetColValue("DoctorTypeId"));

                        // Diagnosis Details
                        html = html.Replace("{{DescriptionName}}", dt.GetColValue("DescriptionName"));
                        html = html.Replace("{{DescriptionType}}", dt.GetColValue("DescriptionType"));
                        html = html.Replace("{{Expr7}}", dt.GetColValue("Expr7"));
                        html = html.Replace("{{Expr8}}", dt.GetColValue("Expr8"));
                        ...
                        // Additional Fields
                        html = html.Replace("{{OPIPID}}", dt.GetColValue("OPIPID"));
                        html = html.Replace("{{Expr9}}", dt.GetColValue("Expr9"));
                        html = html.Replace("{{Expr10}}", dt.GetColValue("Expr10"));
                        html = html.Replace("{{Expr11}}", dt.GetColValue("Expr11"));
                        html = html.Replace("{{Age}}", dt.GetColValue("Age"));
                ...
                case "OTRequestReport":
                    {
                        ...
                        html = html.Replace("{{UHIDNo}}", dt.GetColValue("RegNo"));
                        html = html.Replace("{{OPDIPDNo}}", dt.GetColValue("OPDNo") + " | " + dt.GetColValue("IPDNo"));
                        html = html.Replace("{{PatientName}}", dt.GetColValue("PatientName"));
                        html = html.Replace("{{Gender}}", dt.GetColValue("GenderName"));
                        html = html.Replace("{{AgeYear}}", dt.GetColValue("AgeYear"));
                        html = html.Replace("{{AgeMonth}}", dt.GetColValue("AgeMonth"));
                        ...
                        html = html.Replace("{{DOA}}", dt.GetColValue("AdmissionDate").ConvertToDateString("dd-MM-yyyy"));
                        html = html.Replace("{{DOATime}}", dt.GetColValue("AdmissionTime").ConvertToDateString("hh:mm tt"));
                        ...
                        html = html.Replace("{{SurgeryName}}", dt.GetColValue("SurgeryName"));
                        html = html.Replace("{{SurgeryType}}", dt.GetColValue("TypeName"));
                        html = html.Replace("{{SurgeonName}}", dt.GetColValue("SurgeonName"));
                        html = html.Replace("{{OTRequestTime}}", dt.GetColValue("OTRequestTime").ConvertToDateString("dd-MM-yyyy hh:mm tt"));
                        html = html.Replace("{{OTRequestDate}}", dt.GetColValue("OTRequestDate").ConvertToDateString("dd-MM-yyyy"));
                        html = html.Replace("{{SiteDescriptionName}}", dt.GetColValue("SiteDescriptionName"));
                        html = html.Replace("{{SurgeryCategoryName}}", dt.GetColValue("SurgeryPart"));


                        html = html.Replace("{{OTDepartment}}", dt.GetColValue("DepartmentName"));


                        html = html.Replace("{{AnesthesiaName}}", dt.GetColValue("AnesthesiaName"));
                        html = html.Replace("{{OTTableName}}", dt.GetColValue("OTTableName"));
                ...
                case "PharamcySalesBill":
                    {
                        ...
                        html = html.Replace("{{Date}}", dt.GetColValue("Time").ConvertToDateString("dd/MM/yyyy hh:mm tt"));
                        html = html.Replace("{{Date}}", dt.GetColValue("Time").ToString());
                ...
                case "NursingVitalsReport":
                    {
                        ...
                        foreach (DataRow dr in dt.Rows)
                        {
                            ...
                            items.Append("<tr style=\"text-align: center; border: 1px solid #d4c3c3; padding: 6px;font-size: 18px;\"><td style=\"text-align: center; border: 1px solid #d4c3c3; padding: 6px;\">").Append(i).Append("</td>");
                            items.Append("<td style=\" border: 1px solid #d4c3c3; text-align: left; padding: 6px;\">").Append(dr["Temperature"].ConvertToString()).Append("</td>");
                            items.Append("<td style=\" border: 1px solid #d4c3c3; text-align: left; padding: 6px;\">").Append(dr["Pulse"].ConvertToString()).Append("</td>");
                            items.Append("<td style=\" border: 1px solid #d4c3c3; text-align: left; padding: 6px;\">").Append(dr["Respiration"].ConvertToString()).Append("</td>");
                            items.Append("<td style=\" border: 1px solid #d4c3c3; text-align: left; padding: 6px;\">").Append(dr["BloodPresure"].ConvertToString()).Append("</td>");
                            items.Append("<td style=\" border: 1px solid #d4c3c3; text-align: left; padding: 6px;\">").Append(dr["CVP"].ConvertToString()).Append("</td>");
                            items.Append("<td style=\" border: 1px solid #d4c3c3; text-align: left; padding: 6px;\">").Append(dr["Peep"].ConvertToString()).Append("</td>");
                            items.Append("<td style=\" border: 1px solid #d4c3c3; text-align: left; padding: 6px;\">").Append(dr["ArterialBloodPressure"].ConvertToString()).Append("</td>");
                            items.Append("<td style=\" border: 1px solid #d4c3c3; text-align: left; padding: 6px;\">").Append(dr["PAPressureReading"].ConvertToString()).Append("</td>");
                            items.Append("<td style=\" border: 1px solid #d4c3c3; text-align: left; padding: 6px;\">").Append(dr["Brady"].ConvertToString()).Append("</td>");
                            items.Append("<td style=\" border: 1px solid #d4c3c3; text-align: left; padding: 6px;\">").Append(dr["Apnea"].ConvertToString()).Append("</td>");
                            items.Append("<td style=\" border: 1px solid #d4c3c3; text-align: left; padding: 6px;\">").Append(dr["AbdominalGrith"].ConvertToString()).Append("</td>");
                            items.Append("<td style=\" border: 1px solid #d4c3c3; text-align: left; padding: 6px;\">").Append(dr["Desaturation"].ConvertToString()).Append("</td>");
                            items.Append("<td style=\" border: 1px solid #d4c3c3; text-align: left; padding: 6px;\">").Append(dr["SaturationWithO2"].ConvertToString()).Append("</td>");
                            items.Append("<td style=\" border: 1px solid #d4c3c3; text-align: left; padding: 6px;\">").Append(dr["SaturationWithoutO2"].ConvertToString()).Append("</td>");
                            items.Append("<td style=\" border: 1px solid #d4c3c3; text-align: left; padding: 6px;\">").Append(dr["PO2"].ConvertToString()).Append("</td>");
                            items.Append("<td style=\" border: 1px solid #d4c3c3; text-align: left; padding: 6px;\">").Append(dr["FIO2"].ConvertToString()).Append("</td>");
                        ...
                        html = html.Replace("{{AbdominalGrith}}", dt.GetColValue("AbdominalGrith"));
                        html = html.Replace("{{Desaturation}}", dt.GetColValue("Desaturation"));
                        html = html.Replace("{{SaturationWithO2}}", dt.GetColValue("SaturationWithO2"));
                        html = html.Replace("{{SaturationWithoutO2}}", dt.GetColValue("SaturationWithoutO2"));
                        html = html.Replace("{{PO2}}", dt.GetColValue("PO2"));
                        html = html.Replace("{{FIO2}}", dt.GetColValue("FIO2"));
                        html = html.Replace("{{PFRation}}", dt.GetColValue("PFRation"));
                        html = html.Replace("{{SuctionType}}", dt.GetColValue("SuctionType"));
