...
namespace HIMS.Services.IPPatient
{
    ...
    {
        Task InsertAsync(DischargeSummary ObjDischargeSummary, List<TIpPrescriptionDischarge> ObjTIpPrescriptionDischarge, int UserId, string Username);
        Task UpdateSP(DischargeSummary ObjDischargeSummary, List<TIpPrescriptionDischarge> ObjTIpPrescriptionDischarge, int UserId, string Username);
        Task InsertTemplate(DischargeSummary ObjDischargeTemplate, List<TIpPrescriptionDischarge> ObjTIpPrescriptionTemplate, List<TIpAdmissionDiagnosisInformation> ObjTIpAdmissionDiagnosisInformation, int UserId, string Username);
        Task UpdateTemplate(DischargeSummary ObjDischargeTemplate, List<TIpPrescriptionDischarge> ObjTIpPrescriptionTemplate, List<TIpAdmissionDiagnosisInformation> ObjTIpAdmissionDiagnosisInformation, int UserId, string Username);
