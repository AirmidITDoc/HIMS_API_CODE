...
namespace HIMS.Services.Inventory
{
    ...
    //        }
    //    }
    //    public virtual async Task UpdateAsync(TIssueToDepartmentHeader objIssueToDepartment, TCurrentStock objCurrentStock, int UserId, string Username)
    ...
    //            objCurrentStock.StockId = objCurrentStock.StockId;
    //            _context.TCurrentStocks.Add(objCurrentStock);
    //            await _context.SaveChangesAsync();
    ...
    //    public virtual async Task updateStock(TCurrentStock objCurrentStock, int UserId, string Username)
    //    {
    //        using var scope = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions { IsolationLevel = System.Transactions.IsolationLevel.ReadCommitted }, TransactionScopeAsyncFlowOption.Enabled);
    //        {
