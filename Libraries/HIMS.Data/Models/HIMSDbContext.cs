...
namespace HIMS.Data.Models
{
    public partial class HIMSDbContext : DbContext
    {
        ...
        public virtual DbSet<TBillSync> TBillSyncs { get; set; } = null!;
        ...
        public virtual DbSet<TPathologyReportHeaderSync> TPathologyReportHeaderSyncs { get; set; } = null!;
        ...
        public virtual DbSet<TPurchaseRequisitionDetail> TPurchaseRequisitionDetails { get; set; } = null!;
        ...
        public virtual DbSet<TRadiologyReportHeaderSync> TRadiologyReportHeaderSyncs { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<IpdDrugSchedule>(entity =>
            {
                ...
                entity.HasOne(d => d.MedChart)
                    .WithMany(p => p.IpdDrugSchedules)
                    .HasForeignKey(d => d.MedChartId)
            ...
            modelBuilder.Entity<MAdmissionType>(entity =>
            {
                entity.HasKey(e => e.AdmissiontypeId);

                entity.ToTable("M_AdmissionType");

                entity.Property(e => e.AdmissiontypeName)
                    .HasMaxLength(100)
                    .HasColumnName("[AdmissiontypeName");
            ...
            modelBuilder.Entity<MMarketingHospitalMaster>(entity =>
            {
                entity.HasKey(e => e.HospitalId);
                ...
                entity.Property(e => e.DoctorMobileNo).HasMaxLength(10);
            ...
            modelBuilder.Entity<MPresTemplateH>(entity =>
            {
                ...
                entity.Property(e => e.TemplateCategory).HasMaxLength(100);
            });
            ...
            modelBuilder.Entity<MReportSetupOperational>(entity =>
            {
                ...
                entity.Property(e => e.IsA5orA4page).HasColumnName("IsA5orA4Page");

                entity.Property(e => e.IsDbfunction).HasColumnName("IsDBFunction");
            ...
            modelBuilder.Entity<PsLvwRtrvPathologyResultLabwithAge>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ps_lvwRtrv_PathologyResultLABWithAge");
            ...
            modelBuilder.Entity<TBillSync>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("T_BillSync");
                ...
                entity.Property(e => e.BillNo).ValueGeneratedOnAdd();
                ...
                entity.Property(e => e.SpeTaxAmt).HasColumnType("money");
            ...
            modelBuilder.Entity<TDiscountTransactionHistory>(entity =>
            {
                entity.HasKey(e => e.DiscTranId);

                entity.ToTable("T_DiscountTransactionHistory");

                entity.Property(e => e.CompDiscountAmt).HasColumnType("money");
            ...
            modelBuilder.Entity<TExpense>(entity =>
            {
                ...
                entity.Property(e => e.ApprovalBy).HasDefaultValueSql("((0))");

                entity.Property(e => e.ApprovalDate)
                    .HasColumnType("datetime")
                    .HasDefaultValueSql("('')");

                entity.Property(e => e.ApprovalReason)
                    .IsUnicode(false)
                    .HasDefaultValueSql("('')");
                ...
                entity.Property(e => e.IsApproval).HasDefaultValueSql("((0))");
            ...
            modelBuilder.Entity<TGrndetail>(entity =>
            {
                ...
                entity.Property(e => e.HmrpStrip)
                    .HasColumnType("money")
                    .HasColumnName("HMrp_Strip");

                entity.Property(e => e.HmrpUnitPrice)
                    .HasColumnType("money")
                    .HasColumnName("HMrpUnitPrice");
            ...
            modelBuilder.Entity<TLabPatientRegistrationSync>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("T_LabPatientRegistrationSync");
            ...
            modelBuilder.Entity<TMarketingDailyVisitInformation>(entity =>
            {
            ...
            modelBuilder.Entity<TOtReservationCheckInOut>(entity =>
            {
                ...
                entity.Property(e => e.EquipmentCarried).HasMaxLength(255);
            ...
            modelBuilder.Entity<TPathologyReportHeaderSync>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("T_PathologyReportHeaderSync");
                ...
                entity.Property(e => e.PathReportId)
                    .ValueGeneratedOnAdd()
                    .HasColumnName("PathReportID");
            ...
            {
                entity.HasKey(e => e.PatientPolicyId);
            ...
            modelBuilder.Entity<TPaymentDoctor>(entity =>
            {
                entity.HasKey(e => e.PaymentId);

                entity.ToTable("T_PaymentDoctor");
            ...
            modelBuilder.Entity<TPaymentSync>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("T_PaymentSync");
            ...
            modelBuilder.Entity<TPurchaseRequisitionDetail>(entity =>
            {
                entity.HasKey(e => e.PurchaseRequisitionDetId);

                entity.ToTable("T_PurchaseRequisitionDetails");

                entity.HasOne(d => d.PurchaseRequisition)
                    .WithMany(p => p.TPurchaseRequisitionDetails)
                    .HasForeignKey(d => d.PurchaseRequisitionId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_T_PurchaseRequisitionDetails_T_PurchaseRequisitionHeader");
            });

            modelBuilder.Entity<TPurchaseRequisitionHeader>(entity =>
            {
                entity.HasKey(e => e.PurchaseRequisitionId)
                    .HasName("PK_t_PurchaseRequisitionHeader");

                entity.ToTable("T_PurchaseRequisitionHeader");
                ...
                entity.Property(e => e.PurchaseRequisitionTime).HasColumnType("datetime");
            ...
            modelBuilder.Entity<TRadiologyReportHeaderSync>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("T_RadiologyReportHeaderSync");
                ...
                entity.Property(e => e.RadReportId).ValueGeneratedOnAdd();
            ...
            {
                entity.HasKey(e => e.SalesDetId)
                    .HasName("PK_T_Sales_InpatientDetails");

                entity.ToTable("T_SalesInpatientDetails");
                ...
                entity.HasOne(d => d.Sales)
                    .WithMany(p => p.TSalesInpatientDetails)
                    .HasForeignKey(d => d.SalesId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_T_SalesInpatientDetails_T_SalesInpatientHeader");
            });

            modelBuilder.Entity<TSalesInpatientHeader>(entity =>
            {
                entity.HasKey(e => e.SalesId);

                entity.ToTable("T_SalesInpatientHeader");
            ...
            modelBuilder.Entity<VTPayment>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("V_T_PAYMENT");
