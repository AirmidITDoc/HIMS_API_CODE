...
namespace HIMS.Data.Models
{
    public partial class HIMSDbContext : DbContext
    {
        ...
        public virtual DbSet<TMrdtemplate> TMrdtemplates { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Admission>(entity =>
            {
                ...
                entity.Property(e => e.ParentOpipid).HasColumnName("ParentOPIPid");
            ...
            modelBuilder.Entity<DocumentFile>(entity =>
            {
                ...
                entity.HasOne(d => d.Admission)
                    ...
                    .HasConstraintName("FK_DocumentFiles_Admission");
            ...
            modelBuilder.Entity<TMrdtemplate>(entity =>
            {
                entity.HasKey(e => e.TemplateId);

                entity.ToTable("T_MRDTemplate");
            ...
            modelBuilder.Entity<VTPaymentDoctorAmount>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("V_T_PAYMENT_DOCTOR_AMOUNT");
