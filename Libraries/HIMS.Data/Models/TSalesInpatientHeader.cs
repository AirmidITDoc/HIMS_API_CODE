...
{
    public partial class TSalesInpatientHeader
    {
        public TSalesInpatientHeader()
        {
            TSalesInpatientDetails = new HashSet<TSalesInpatientDetail>();
        }
        ...
        public virtual ICollection<TSalesInpatientDetail> TSalesInpatientDetails { get; set; }
    }
}
