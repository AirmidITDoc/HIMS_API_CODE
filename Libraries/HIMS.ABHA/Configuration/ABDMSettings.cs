...
namespace HIMS.ABHA.Configuration
{
    public static class AppSettings
    {
        public static ABDMSettings Current { get; set; } = new();
        public static void Initialize(IConfiguration configuration)
        {
            Current = configuration.Get<ABDMSettings>() ?? new ABDMSettings();
        }
    }
    ...
    public class Endpoints
    {
        ...
        public string DiscoverReqUrl { get; set; } = string.Empty;
        public string UserInitLinking { get; set; } = string.Empty;
        public string UserConfirmLinking { get; set; } = string.Empty;
