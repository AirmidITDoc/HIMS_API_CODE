        ...
        public async Task<ActionResult> GetBindDropDown(string mode, int? Id)
        {
            IList<SelectListItem> Result = mode switch
            {
               ...
               .ToList().ToDropDown("DoctorId", "FirstName"),
                ...
                "PharmacyStore" => (await _IMStoreService.GetAll(x => x.IsPharStore.Value)).ToList().ToDropDown(nameof(MStoreMaster.StoreId), nameof(MStoreMaster.StoreName)),
                ...
                "DrugTimeDurationMaster" => (await _MedicalRecordConfig.GetAll(x => x.IsActive)).ToList().ToDropDown(nameof(MedicalRecordConfig.Id), nameof(MedicalRecordConfig.Code)),
                //"PathSpecimenPreservativeMaster" => (await _MPathSpecimenPreservativeMaster.GetAll(x => x.IsActive.Value)).ToList().ToDropDown(nameof(MPathSpecimenPreservativeMaster.SpecimenPreservativeId), nameof(MPathSpecimenPreservativeMaster.PreservativeUsed)),
                ...
                "DietCategoryMaster" => (await _MDietCategoryMaster.GetAll(x => x.IsActive.Value)).ToList().ToDropDown(nameof(MDietCategoryMaster.DietCategoryId), nameof(MDietCategoryMaster.CategoryName)),
