...
namespace HIMS.API.Controllers.Masters.OTMaster
{
    public class ConsentMasterController :BaseController
    {
        ...
        public async Task<ApiResponse> Post(ConsentMasterModel obj)
        {
            ...
            return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "ConsentMaster added successfully.");
        }
        ...
        public async Task<ApiResponse> Edit(ConsentMasterModel obj)
        {
            ...
            return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "ConsentMaster updated successfully.");
        }
        ...
        public async Task<ApiResponse> Delete(int Id)
        {
            ...
            if ((model?.ConsentId ?? 0) > 0)
            {
                ...
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "ConsentMaster deleted successfully.");
            }
            else
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status500InternalServerError, "Invalid params");
        }
