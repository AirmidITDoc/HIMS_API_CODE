...
namespace HIMS.API.Controllers.Masters.InventoryMaster
{
    ...
    public class ItemManufactureMasterController : BaseController
    {
        ...
        public async Task<ApiResponse> Post(ItemManufactureModel obj)
        {
            ...
            return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "ItemManufacture Name  added successfully.");
        }
        //Edit API
        [HttpPut("{id:int}")]
        ...
        public async Task<ApiResponse> Edit(ItemManufactureModel obj)
        {
            ...
            return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "ItemManufacture Name updated successfully.");
        }
        //Delete API
        [HttpDelete]
        ...
        public async Task<ApiResponse> Delete(int Id)
        {
            ...
            if ((model?.ItemManufactureId ?? 0) > 0)
            {
                ...
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "ItemManufacture deleted successfully.");
            }
            else
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status500InternalServerError, "Invalid params");
        }
