...
namespace HIMS.API.Controllers.Masters.Personal_Information
{
    ...
    public class VillageMasterController : BaseController
    {
        ...
        [HttpPost]
        [Route("[action]")]
        [Permission(PageCode = "VillageMaster", Permission = PagePermission.View)]
        ...
        //Add API
        [HttpPost]
        [Permission(PageCode = "VillageMaster", Permission = PagePermission.Add)]
        ...
        //Edit API
        [HttpPut("{id:int}")]
        [Permission(PageCode = "VillageMaster", Permission = PagePermission.Edit)]
        ...
        //Delete API
        [HttpDelete]
        [Permission(PageCode = "VillageMaster", Permission = PagePermission.Delete)]
