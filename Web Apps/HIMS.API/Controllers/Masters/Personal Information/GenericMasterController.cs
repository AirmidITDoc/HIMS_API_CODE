...
namespace HIMS.API.Controllers.Masters.Personal_Information
{
    ...
    public class GenericMasterController : BaseController
    {
        ...
        public async Task<ApiResponse> Post(GenericMasterModel obj)
        {
            ...
            return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "GenericName added successfully.");
        }
        //Edit API
        [HttpPut("{id:int}")]
        ...
        public async Task<ApiResponse> Edit(GenericMasterModel obj)
        {
            ...
            return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "GenericName  updated successfully.");
        }
        //Delete API
        [HttpDelete]
        ...
        public async Task<ApiResponse>  Delete(int Id)
        {
            ...
            if ((model?.GenericId ?? 0) > 0)
            {
                ...
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "GenericName  deleted successfully.");
            }
            else
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status500InternalServerError, "Invalid params");
        }
