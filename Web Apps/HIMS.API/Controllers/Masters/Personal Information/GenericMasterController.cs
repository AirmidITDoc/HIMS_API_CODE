...
namespace HIMS.API.Controllers.Masters.Personal_Information
{
    ...
    public class GenericMasterController : BaseController
    {
        ...
        public GenericMasterController(IGenericService<MItemGenericNameMaster> repository)
        {
        ...
        {
            IPagedList<MItemGenericNameMaster> MGenericMasterList = await _repository.GetAllPagedAsync(objGrid);
        ...
        public async Task<ApiResponse> Get(int id)
        {
            ...
            return data.ToSingleResponse<MItemGenericNameMaster, GenericMasterModel>("Generic");
        }
        //Add API
        [HttpPost]
