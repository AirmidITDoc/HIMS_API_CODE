...
namespace HIMS.API.Controllers.Masters.Personal_Information
{
    ...
    public class CertificateTemplateController : BaseController
    {
        ...
        {
            IPagedList<MCertificateTemplateMaster> CertificateTemplateList = await _repository.GetAllPagedAsync(objGrid);
            return Ok(CertificateTemplateList.ToGridResponse(objGrid, "CertificateTemplate List"));
        }
        //List API Get By Id
        [HttpGet("{id?}")]
        [Permission(PageCode = "CertificateTemplateMaster", Permission = PagePermission.View)]
        public async Task<ApiResponse> Get(int id)
        {
            ...
            return data.ToSingleResponse<MCertificateTemplateMaster, CertificateTemplateModel>("CertificateTemplateMaster");
        }
        //Add API
        [HttpPost]
        ...
        public async Task<ApiResponse> Post(CertificateTemplateModel obj)
        {
            ...
            return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "CertificateTemplate Name added successfully.");
        }
        //Edit API
        [HttpPut("{id:int}")]
        ...
        public async Task<ApiResponse> Edit(CertificateTemplateModel obj)
        {
            ...
            return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "CertificateTemplate Name  updated successfully.");
        }
        //Delete API
        [HttpDelete]
        ...
        public async Task<ApiResponse> Delete(int Id)
        {
            ...
            if ((model?.TemplateId ?? 0) > 0)
            {
                ...
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "CertificateTemplate deleted successfully.");
            }
            else
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status500InternalServerError, "Invalid params");
        }
