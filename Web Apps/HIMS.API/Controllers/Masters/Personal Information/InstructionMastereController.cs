...
namespace HIMS.API.Controllers.Masters.Personal_Information
{
    ...
    public class InstructionMastereController : BaseController
    {
        ...
        public async Task<ApiResponse> Post(InstructionMasterModel obj)
        {
            ...
            return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "Instruction Description added successfully.");
        }
        //Edit API
        [HttpPut("{id:int}")]
        ...
        public async Task<ApiResponse> Edit(InstructionMasterModel obj)
        {
            ...
            return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "Instruction Descreption updated successfully.");
        }
        //Delete API
        [HttpDelete]
        ...
        public async Task<ApiResponse> Delete(int Id)
        {
            ...
            if ((model?.InstructionId ?? 0) > 0)
            {
                ...
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "Instruction description deleted successfully.");
            }
            else
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status500InternalServerError, "Invalid params");
        }
