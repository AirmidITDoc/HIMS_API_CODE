...
namespace HIMS.API.Controllers.Masters.Personal_Information
{
    ...
    public class LocationMasterController : BaseController
    {
        ...
        public async Task<ApiResponse> Get(int id)
        {
            ...
            return data.ToSingleResponse<LocationMaster, LocationMasterModel>("LocationName");
        }
        ...
        public async Task<ApiResponse> Post(LocationMasterModel obj)
        {
            ...
            return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "Location added successfully.");
        }
        ...
        public async Task<ApiResponse> Edit(LocationMasterModel obj)
        {
            ...
            return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "Location updated successfully.");
        }
        ...
        public async Task<ApiResponse> delete(int Id)
        {
            ...
            if ((model?.LocationId ?? 0) > 0)
            {
                ...
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "location deleted successfully.");
            }
            else
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status500InternalServerError, "Invalid params");
        }
