...
namespace HIMS.API.Controllers.Masters.Personal_Information
{
    ...
    public class ItemCategoryMasterController : BaseController
    {
        ...
        public async Task<ApiResponse> Post(ItemCategoryModel obj)
        {
            ...
            return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "Item Category Name added successfully.");
        }
        //Edit API
        [HttpPut("{id:int}")]
        ...
        public async Task<ApiResponse> Delete(int Id)
        {
            ...
            if ((model?.ItemCategoryId ?? 0) > 0)
            {
                ...
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "Item Category Name deleted successfully.");
            }
            else
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status500InternalServerError, "Invalid params");
        }
