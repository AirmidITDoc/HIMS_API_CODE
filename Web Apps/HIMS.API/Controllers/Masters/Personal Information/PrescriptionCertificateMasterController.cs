...
namespace HIMS.API.Controllers.Masters.Personal_Information
{
 ...
 [Route("api/v{version:apiVersion}/[controller]")]
    ...
    public class PrescriptionCertificateMasterController : BaseController
    {
        ...
        public PrescriptionCertificateMasterController(IGenericService<MAreaMaster> repository)
        {
        ...
        //    }
        //    var data = await _repository.GetById(x => x.AreaId == id);
        //    return data.ToSingleResponse<MAreaMaster, AreaMasterModel>("AreaMaster");
        //}
