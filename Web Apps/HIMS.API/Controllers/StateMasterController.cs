...
namespace HIMS.API.Controllers.Masters.Personal_Information
{
        ...
        public class StateMasterController : BaseController
        {
            ...
            public async Task<ApiResponse> Get(int id)
            {
                ...
                return data.ToSingleResponse<MStateMaster, StateMasterModel>("Prefix");
            }
        ...
        public async Task<ApiResponse> post(StateMasterModel obj)
        {
            ...
            return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "State added successfully.");
        }
        //Edit API
        [HttpPut("{id:int}")]
        ...
        public async Task<ApiResponse> Edit(StateMasterModel obj)
        {
            ...
            return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "State updated successfully.");
        }
        //Delete API
        [HttpDelete]
        ...
        public async Task<ApiResponse> delete(int Id)
        {
            ...
            if ((model?.StateId ?? 0) > 0)
            {
                ...
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "State deleted successfully.");
            }
            else
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status500InternalServerError, "Invalid params");
        }
