...
{
    public class InstructionMasterController : BaseController
    {
        private readonly IGenericService<MInstructionMaster> _repository;
        public InstructionMasterController(IGenericService<MInstructionMaster> repository)
        {
        ...
        public async Task<ApiResponse> post(InstructionMasterModel obj)
        {
            ...
            return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "Instruction added successfully.");
        }
        //Edit API
        [HttpPut("{id:int}")]
        ...
        public async Task<ApiResponse> Edit(InstructionMasterModel obj)
        {
            ...
            return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "Instruction updated successfully.");
        }
        //Delete API
        [HttpDelete]
        ...
        public async Task<ApiResponse> delete(int Id)
        {
            ...
            if ((model?.InstructionId ?? 0) > 0)
            {
                ...
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "Instruction deleted successfully.");
            }
            else
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status500InternalServerError, "Invalid params");
        }
