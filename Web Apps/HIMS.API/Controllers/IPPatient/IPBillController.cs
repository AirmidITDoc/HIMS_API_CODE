    ...
    public class IPBillController : BaseController
    {
        ...
        public async Task <ApiResponse> Insertsp(BillingModel obj)
        {
            ...
            if (obj.Bill.BillNo == 0)
            {
                ...
                await _IPBillService.IPbillSp(Model, BillDetailModel, AddChargeModel, AddmissionModel, paymentModel, BillModel, objAdvanceDetail, objAdvanceHeader, ObjTPayment, CurrentUserId, CurrentUserName);
            }
            else
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status500InternalServerError, "Invalid params");
        ...
        public async Task <ApiResponse> InsertCreditSP(BillingModel obj)
        {
            ...
            if (obj.Bill.BillNo == 0)
            {
                ...
                Model.ModifiedBy = CurrentUserId;
                Model.ModifiedDate = AppTime.Now;
                await _IPBillService.IPbillCreditSp(Model, BillDetailModel, AddChargeModel, AddmissionModel, BillModel, objAdvanceDetail, objAdvanceHeader, CurrentUserId, CurrentUserName);
            }
            else
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status500InternalServerError, "Invalid params");
        ...
        public async Task <ApiResponse> IPInterimBillCashCounterAsyncSp(IPBillModel obj)
        {
            ...
            if (obj.IPBillling.BillNo == 0)
            {
                ...
                Model.ModifiedBy = CurrentUserId;
                Model.ModifiedDate = AppTime.Now;
                await _IPBillService.IPInterimBillCashCounterSp(AddChargeModel, Model, BillDetailModel, paymentModel , objAdvanceDetail, objAdvanceHeader ,ObjTPayment, CurrentUserId, CurrentUserName);
            }
            else
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status500InternalServerError, "Invalid params");
            return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, " Record added successfully.", paymentModel.BillNo);
        ...
        public async Task <ApiResponse> InsertIP(TDrbillingModel obj)
        {
            ...
            if (obj.TDrbill.Drbno == 0)
            {
                ...
                Model.AddedBy = CurrentUserId;
                await _IPBillService.IPDraftBill(Model, DetModel, CurrentUserId, CurrentUserName);
            }
            else
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status500InternalServerError, "Invalid params");
        ...
        public ApiResponse IPAddcharges(AddChargModel obj)
        {
            ...
            if (obj.AdddCharges.ChargesId == 0)
            {
                ...
                Model.AddedBy = CurrentUserId;
                _IPBillService.IPAddcharges(Model, Models, CurrentUserId, CurrentUserName);
            }
            else
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status500InternalServerError, "Invalid params");
            return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "Record Added successfully.");
        ...
        public ApiResponse Update(UpdateAddchargesModel obj)
        {
            AddCharge model = obj.MapTo<AddCharge>();
            if (obj.ChargesId == 0)
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status500InternalServerError, "Invalid params");
        ...
        public ApiResponse InsertIPDPackage(IPAddChargesModel obj)
        {
            ...
            if (obj.ChargesId == 0)
            {
                ...
                Model.AddedBy = CurrentUserId;
                _IPBillService.InsertIPDPackage(Model, CurrentUserId, CurrentUserName);
            }
            else
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status500InternalServerError, "Invalid params");
            return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "Record Added successfully.");
        ...
        [Permission(PageCode = "Bill", Permission = PagePermission.Add)]
        public ApiResponse Insert(classWiseRateModel obj)
        {
            AddCharge Model = obj.MapTo<AddCharge>();
            ...
            if (obj.OpdIpdId != 0)
            {
                ...
                Model.AddedBy = CurrentUserId;
                _IPBillService.InsertSP(Model, CurrentUserId, CurrentUserName);
            }
            else
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status500InternalServerError, "Invalid params");
            return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "Record Added successfully.");
        ...
        [Permission(PageCode = "Bill", Permission = PagePermission.Add)]
        public ApiResponse InsertC(ClassRateModel obj)
        {
            if (obj.ClassId == 0)
            {
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status500InternalServerError, "Invalid params");
        ...
        [Permission(PageCode = "Bill", Permission = PagePermission.Add)]
        public ApiResponse InsertT(TariffwiseClassRatechangeModel obj)
        {
            if (obj.ClassId == 0)
            {
                return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status500InternalServerError, "Invalid params");
