...
namespace HIMS.API.Controllers.NursingStation
{
    ...
    public class LabRequestController : BaseController
    {
        ...
        public LabRequestController(ILabRequestService repository, HIMSDbContext HIMSDbContext, INotificationUtility notificationUtility)
        {
        ...
        //        //get patient details
        //        var objPatient = await _ILabRequestService.PatientByAdmissionId(model.OpIpId.Value);
