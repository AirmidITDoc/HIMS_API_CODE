...
namespace HIMS.API.Controllers.OPPatient
{
    ...
    public class RefundOfBillController : BaseController
    {
        ...
        [Permission(PageCode = "OPRefund", Permission = PagePermission.View)]
        ...
        public async Task<ApiResponse> InsertSP(RefundBillModel obj)
        {
            ...
            return ApiResponseHelper.GenerateResponse(ApiStatusCode.Status200OK, "Refund added successfully.", model);
        }
