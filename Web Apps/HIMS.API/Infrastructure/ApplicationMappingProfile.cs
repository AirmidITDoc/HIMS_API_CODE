...
namespace HIMS.API.Infrastructure
{
    public class ApplicationMappingProfile : Profile
    {
        public ApplicationMappingProfile()
        {
            ...
            CreateMap<MOutSourcelabMaster, OutSourcelabMasterModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<MExternalDoctorMaster, ExternalDoctorModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<MDietTypeMaster, DietTypeMasterModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<TPatientPolicyInformation, PatientPolicyModels>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<TDrbill, ApprovalHeaderUpdateModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<TEmergencyAdm, EmergencyModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<TGrnreturnDetail, GrnreturnUpdate>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<TPaymentDoctor, DoctorPayyModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            CreateMap<TDoctorPayoutProcessHeader, DoctorUnprocessModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<PaymentPharmacy, paymentpharmacyUpdateModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<TExpense, ExpenseUpdateModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<TSalesHeader, SalesHederUpdateModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            CreateMap<TSalesDetail, SalesDetailsUpdateModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            CreateMap<TCurrentStock, CurrentStockUpdateModels>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<TIpAdmissionDiagnosisInformation, TIpAdmissionDiagnosisInformationModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            CreateMap<TIpAdmissionDiagnosisInformation, TIpAdmissionDiagnosisInformationUpdate>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<TLoginCashCounterDetail, LoginCashCounterDetailModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<MHsncodeMaster, HSNCodeMasterModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<TReportLog, ReportLogModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<Registration, RegistrationModel1>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            CreateMap<Registration, AppRegistrationBill1>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<TPathologyReportHeader, PathologyUpdateDateTimeModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<AddCharge, ClassRateModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            CreateMap<AddCharge, TariffwiseClassRatechangeModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<TPayment, PaymenntModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            CreateMap<TPaymentPharmacy, PaymenntModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            CreateMap<TPaymentPharmacy, TpaymentUpdateModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            CreateMap<TPaymentPharmacy, paymentUpdateModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            CreateMap<VisitDetail, VisitUpdateModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            CreateMap<TDrbill, DRBillModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            CreateMap<TDrbillDet, TDrbillDetModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<OpeningBalHeaderModel, TOpeningTransactionHeader>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            CreateMap<OpeningTransactionDetails, TOpeningTransactionDetail>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<PaymentPharmacy, PharaModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            //AppointmentBillModel?
            CreateMap<Bill, AppOPBillIngModels>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            CreateMap<VisitDetail, AppVisitDetailModel1>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<AddCharge, Packcagechargemodel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<Bill, BillGovtUpdateModels>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<Admission, AdmissionUpdate>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            CreateMap<AddCharge, ShareDoctAddChargesUpdate>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<TPatientPolicyInformation, PatientPolicyModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<VisitDetail, VisitDateTimeModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            CreateMap<TOtReservationHeader, ReservationModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            CreateMap<TOtReservationAttendingDetail, OtReservationAttendingDetailModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            CreateMap<TOtReservationSurgeryDetail, TOtReservationSurgeryDetailModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            CreateMap<TOtReservationHeader, ReservationGetModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            CreateMap<TOtReservationHeader, TOtRequestDiagnosisModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            CreateMap<VisitDetail, FollowupDateUpdateModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<TLabPatientRegistration, LabPatientRegistrationModels>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
