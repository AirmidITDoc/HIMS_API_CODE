...
namespace HIMS.API.Infrastructure
{
    public class ApplicationMappingProfile : Profile
    {
        public ApplicationMappingProfile()
        {
            ...
            CreateMap<MModeOfPayment, MModeOfPaymentModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            //CreateMap<PermissionMaster, PermissionMasterModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
           ...
           CreateMap<Discharge, DischargeUpdateModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<InitiateDischarge, InitiateDisModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
        ...
        //    CreateMap<VisitDetail, UpdateVitalInfModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            //CreateMap<MOpcasepaperososisMaster, MOPCasepaperDignosisMasterModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
            ...
            CreateMap<TNursingNote, NursingNoteModel>().ReverseMap().IgnoreAllPropertiesWithAnInaccessibleSetter();
