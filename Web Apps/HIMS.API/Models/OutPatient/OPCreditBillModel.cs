...
{
    public class OPCreditBillModel
    {
    ...
    public class OPCreditBillModelValidator : AbstractValidator<OPCreditBillModel>
    {
        public OPCreditBillModelValidator()
        {
    ...
    public class CreditBillDetailsModel
    {
        public int BillNo { get; set; }
        public int ChargesId { get; set; }
    }

    public class CreditBillDetailsModelValidator : AbstractValidator<CreditBillDetailsModel>
    {
        public CreditBillDetailsModelValidator()
        {
    ...
    public class CreditBillChargesModel
    {
    ...
    public class CreditBillChargesModelValidator : AbstractValidator<CreditBillChargesModel>
    {
        public CreditBillChargesModelValidator()
        {
